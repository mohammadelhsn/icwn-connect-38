...
const PrayerTimesSection = () => {
  ...
  const prayerTimes = [
    ...
    { name: 'Dhuhr', time: '12:45', next: false },
    { name: 'Asr', time: '15:45', next: true },
    { name: 'Maghrib', time: '18:20', next: false },
    { name: 'Isha', time: '19:40', next: false }
  ];
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-2 h-2 rounded-full ${
                        prayer.next ? 'bg-green-700' : 'bg-beige-200'
                      }`} />
                    ...
                    <div className="text-right">
                      <span className={`font-body font-semibold tabular-nums ${
                        prayer.next ? 'text-green-700 text-lg' : 'text-foreground'
                      }`}>
              ...
              <div className="mt-6 pt-6 border-t border-beige-200">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className="text-sm text-ink-600 font-body">
                    <p>Jummah (Friday Prayer): 12:30 PM</p>
